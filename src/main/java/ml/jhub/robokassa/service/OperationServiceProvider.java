...
public interface OperationServiceProvider {
	 ...
	 * 
	 * @param model
	 *            модель данных с информацией об невыполнении операции
	 ...
	 * 
	 * @param nInvId
	 *            идентификатор платежа внутри системы
	...
	/**
	 * Обработать ошибку, которая произошла при завершении платежа
	 * 
	 * @param nInvId
	 ...
	 * @param string
	 *            Место, в котором произошла ошибка(success, confirm, failed)
	 */
